    ...
    return (
        <section className='container mx-auto px-4'>
            <div className='bg-[#15171D] p-10 flex flex-col justify-center items-center space-y-4 rounded-xl'>
                ...
                <button className="flex items-center gap-2 mt-7 rounded-lg bg-brand px-6 py-3 font-semibold text-black transition-all duration-300 hover:scale-105 hover:shadow-lg">
                    Go to workouts
                </button>
            </div>
        </section>
